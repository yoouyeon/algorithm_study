---
title: 11723. 집합
description: 백준 11723번 풀이
date: 2022-01-27T09:00:00+09:00
category: ["baekjoon"]
---
...
위 내용을 일반화 해 보면 x번째 비트를 제거하기 위해 집합에 `AND` 연산해줄 그 값은 1을 왼쪽으로 x번 `shift`한 값을 `NOT` 연산으로 비트를 반전시켜서 만들 수 있다. 이 내용을 코드로 표현하면 다음과 같다.
