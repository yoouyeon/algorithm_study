...
- [700. Search in a Binary Search Tree](https://leetcode.com/problems/search-in-a-binary-search-tree) — [풀이](Easy/700_search-in-a-binary-search-tree.ts)
- [724. Find Pivot Index](https://leetcode.com/problems/find-pivot-index) — [풀이](Easy/724_find-pivot-index.ts)
- [746. Min Cost Climbing Stairs](https://leetcode.com/problems/min-cost-climbing-stairs) — [풀이](Easy/746_min-cost-climbing-stairs.ts)
...
- [872. Leaf-Similar Trees](https://leetcode.com/problems/leaf-similar-trees) — [풀이](Easy/872_leaf-similar-trees.ts)
...
- [1137. N-th Tribonacci Number](https://leetcode.com/problems/n-th-tribonacci-number/description) — [풀이](Easy/1137_n-th-tribonacci-number.ts)
...
- [2620. Counter](https://leetcode.com/problems/counter) — [풀이](Easy/2620_counter.ts)
- [2667. Create Hello World Function](https://leetcode.com/problems/create-hello-world-function) — [풀이](Easy/2667_create-hello-world-function.ts)
...
- [72. Edit Distance](https://leetcode.com/problems/edit-distance) — [풀이](Medium/72_edit-distance.ts)
...
- [216. Combination Sum III](https://leetcode.com/problems/combination-sum-iii) — [풀이](Medium/216_combination-sum-iii.ts)
...
- [1926. Nearest Exit from Entrance in Maze](https://leetcode.com/problems/nearest-exit-from-entrance-in-maze) — [풀이](Medium/1926_nearest-exit-from-entrance-in-maze.ts)
